...
ggsave("figuresTables/Figure [functional_figure].png", height=9, width=9, units="in")
ggsave("figuresTables/Figure [functional_figure].pdf", height=9, width=9, units="in")
